...
import { api, os, store } from '@/bindings';
import { ColorMode, colorModeList, useColorMode } from '@/libs/theme';
...
export default function Index() {
  ...
  async function testOS() {
    appendLog(await os.arch());
    appendLog(await os.family());
    appendLog(await os.hostname());
    appendLog(await os.locale());
    appendLog(await os.osType());
    appendLog(await os.platform());
    appendLog(await os.version());
  }
